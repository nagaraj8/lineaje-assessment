...
public class LineajeRangeServiceTest {
	
	static LineajeRangeService underTest = null;

	@BeforeAll
	static void setUpBeforeClass() throws Exception {
		underTest = new LineajeRangeService();
	}
	...
	void testProcessFamilyData() throws Exception {
		...
		Assert.assertEquals(FileUtils.readLines(new File("src\\test\\java\\com\\lineaje\\assessment\\service\\resources\\LineajeRange.txt")), FileUtils.readLines(new File("LineajeRange.txt")));
	}
