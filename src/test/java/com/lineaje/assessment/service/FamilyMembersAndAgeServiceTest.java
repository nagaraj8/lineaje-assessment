...
public class FamilyMembersAndAgeServiceTest {
	...
	void testProcessFamilyData() throws Exception {
		...
		Assert.assertEquals(FileUtils.readLines(new File("src\\test\\java\\com\\lineaje\\assessment\\service\\resources\\FamilyMembersAndAge.txt")), FileUtils.readLines(new File("FamilyMembersAndAge.txt")));
	}
