...
public class FamilyOrderingServiceTest {
	
	static FamilyOrderingService underTest = null;

	@BeforeAll
	static void setUpBeforeClass() throws Exception {
		underTest = new FamilyOrderingService();
	}
	...
	void testProcessFamilyData() throws Exception {
		...
		Assert.assertEquals(FileUtils.readLines(new File("src\\test\\java\\com\\lineaje\\assessment\\service\\resources\\FamilyOrdering.txt")), FileUtils.readLines(new File("FamilyOrdering.txt")));
	}
